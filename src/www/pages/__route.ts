...
export = function(req: nexusframework.Request, res: nexusframework.Response, next: (err?: Error, routedpath?: string) => void) {
    ...
    res.addScript("//unpkg.com/popper.js@1.12.6/dist/umd/popper.js", "4.0.2", "jquery");
    res.addScript("//unpkg.com/bootstrap-material-design@4.0.0-beta.4/dist/js/bootstrap-material-design.js", "4.0.2", "jquery", "popper");
